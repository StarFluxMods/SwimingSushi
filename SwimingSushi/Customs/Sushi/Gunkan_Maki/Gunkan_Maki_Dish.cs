...
{
	public class Gunkan_Maki_Dish : CustomDish
	{
		//CustomGameDataObject
		public override string UniqueNameID => "Gunkan_Maki_Dish";
		...
		public override List<Dish.MenuItem> ResultingMenuItems => new List<Dish.MenuItem>
		{
			new Dish.MenuItem
			{
				Item = (Item)GDOUtils.GetCustomGameDataObject<Gunkan_Maki_Plated>().GameDataObject,
		...
		{
			{ Locale.English, "Boil Rice, add Cooked Seaweed and Roe" }
		};
		...
		public override void OnRegister(GameDataObject gameDataObject)
		{
			...
			{
				Name = "Gunkan Maki",
				Description = "Adds Gunkan Maki as a Main"
			});
